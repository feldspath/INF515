...
\usepackage[demo]{graphicx} % This package draws images
\usepackage{hyperref} 
...
\begin{figure}
    \begin{subfigure}{.5\linewidth}
        \centering
        \includegraphics[width=.9\linewidth]{figures/sphere-tracing1.png}
        \caption{without Phong shading}
        \label{sfig:sphere-tracing1}
    \end{subfigure}%
    \begin{subfigure}{.5\linewidth}
        \centering
        \includegraphics[width=.9\linewidth]{figures/sphere-tracing2.png}
...
Recently, they have been a lot of attempt to represent SDFs as neural networks. 
